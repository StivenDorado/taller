...
const LoginComponent = () => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      setMensaje(response.data.message || 'Inicio de sesión exitoso');
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br">
      <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl w-80 space-y-6">
        ...
        <div className="flex justify-center space-x-6 pt-4">
          ...
          <a href="/npm" className="text-white hover:text-purple-200">
            <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
          ...
          <a href="/registro" className="text-white hover:text-purple-200">
            <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
